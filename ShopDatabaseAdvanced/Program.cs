		...
		static void Main(string[] args)
		{
			...
			using (var db = new AdvancedShopDatabaseContext())
			{
                ...
                else
                {
                    ...
                    Console.WriteLine("Want to see your purchase history? Y/N");
                ...
                {
                    Console.WriteLine();
                    Console.WriteLine("Thank you for visiting our store! Come again, and have a nice day!");
                    db.SaveChanges();
                }
                else
                {
                    Console.WriteLine("Your cart has been deleted! Have a good day");
                }
